...
var CHEST=29, TORCH=30, TORCH_N=31, TORCH_S=32, TORCH_E=33, TORCH_W=34;
...
var BREAK_TIME = {1:0.7, 2:0.6, 3:3.5, 4:1.6, 5:0.35, 6:0.6, 7:1.6, 8:1.8, 19:4.2, 20:4.5, 21:0.6,
  29:1.5, 30:0.05, 31:0.05, 32:0.05, 33:0.05, 34:0.05};
var MAX_STACK = 64;
...
function blockCategory(id){
  ...
  if(id === WOOD || id === PLANK || id === BENCH || id === CHEST) return 'axe';
  if(id === DIRT || id === GRASS || id === SAND) return 'shovel';
  return null;
}
function isTorch(id){ return id >= TORCH && id <= TORCH_W; }
function isSolid(id){ return id !== AIR && !isTorch(id); }
var CHEST_0 = 62;                                              // 62..88 = Truhen-Spiegel (27 Slots)
...
var TOTAL_SLOTS = 89;   // 62 + 27 Truhen-Spiegel
